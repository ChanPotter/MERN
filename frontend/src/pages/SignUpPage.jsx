...
const SignUpPage = () => {
	...
	// useUserStore is a custom hook that manages user state
	// ban dau chung co gia tri la null
	const { signup, loading } = useUserStore();

	// handleSubmit is a function that handles the form submission
	// It prevents the default form submission behavior and calls the signup function
